...
--
--   procedure Power_Down renames
   --   System.BB.Board_Support.Interrupts.Power_Down;
...
--   subtype Time_Span is System.BB.Time.Time_Span;
   ...
   --  ESP Timer use microseconds unit
...
--   --  Create a new thread
--
--   function Thread_Self return Thread_Id renames
...
--   --  Return the thread identifier for the calling task
   ...
   procedure Set_ATCB (Self_ATCB : System.Address);
...
--   function Get_ATCB return System.Address renames
   --   System.BB.Threads.Get_ATCB;
