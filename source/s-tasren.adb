...
--            Uninterpreted_Data :=
--              Caller.Entry_Calls
--  (Caller.ATC_Nesting_Level).Uninterpreted_Data;
--         else
...
--
--      Call_Synchronous
--        (Acceptor, E, Uninterpreted_Data, Simple_Call,
...
--               then
--                  Uninterpreted_Data :=
--  Self_Id.Common.Call.Uninterpreted_Data;
--
--                  pragma Assert (Self_Id.Deferral_Level = 1);
...
--            ATC_Level'Image (Self_Id.ATC_Nesting_Level), 'A'));
--         Entry_Call := Self_Id.Entry_Calls
--  (Self_Id.ATC_Nesting_Level)'Access;
--         Entry_Call.Next := null;
--         Entry_Call.Mode := Mode;
--         Entry_Call.Cancellation_Attempted := False;
